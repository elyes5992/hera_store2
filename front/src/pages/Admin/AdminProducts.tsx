...
interface Product {
  ...
  const AdminProductsPage: React.FC = () => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      } else if (name === 'price' || name === 'countInStock' || name === 'discountPercentage') {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        setSnackbar({
          open: true,
          message: formMode === 'create' ? 'Product created successfully' : 'Product updated successfully',
          severity: 'success',
        });
                ...
                <Grid size ={{xs :12}}>
                  ...
                  {formData.imageUrl && (
                    <Box sx={{ mb: 2, textAlign: 'center' }}>
                      ...
                      >
                        <img 
                          src={formData.imageUrl.startsWith('/') 
