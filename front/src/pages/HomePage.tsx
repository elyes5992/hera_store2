    ...
    >
      ...
      <CardMedia
        ...
        sx={{
          ...
          ".MuiCard-root:hover &": {
            // Target image only when card is hovered
      ...
      >
        ...
        <Box
          sx={{
            ...
            justifyContent: "space-between", // Push rating to left, price to right
            alignItems: "center", // Vertically align items in the middle
            
            mt: 1, // Add some margin-top if needed (adjust from original 'mb: 1' on rating)
